				...
				<nav class="navbar navbar-default">
					...
					<div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
						...
						<ul class="nav navbar-nav">
							...
							<li><a href="about.php">Google Map</a></li>
			...
			<div class="wthree_banner_info">
				...
				<section class="slider">
					<div class="flexslider">
						<ul class="slides">
							<li>
								<h3>Protoype of Disaster Awareness System</h3>
								<p>Please Feel Free to Explore the Page</p>
								
							</li>
							<li>
								<h3>Welcom to the Page</h3>
								<p>You can try navigate through this website via the navbar</p>
