		...
		<div class="container">
			...
			<div class="wthree_gallery_grids">
				...
				<div class="row">
					...
					<div class="col-md-12">
						<br>
						<a href="blog.php"><i class="fa fa-arrow-left"> Back</i></a></br>
						<br>
						<style>
                        ...
                        <img src="admin/functions/upload/'.$row["image"].'" alt="Images" class="center">
						<br>
						<h5 style="color: orange;">'.$row["author"].' <b style="color: #120;">|</b> ('.mysqli_num_rows($query2).') Comments <b style="color: #120;">|</b> '.$row["date"].'</h5>
						</br>
						<br>
