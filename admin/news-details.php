                        ...
                        <div class="white-box">
                            <div class="row">
                                ...
                                <?php 
                                    ...
                                    $sql="SELECT * FROM colleges WHERE id='$collegesid'";
                                ...
                                '<div class="col-lg-12 col-md-9 col-sm-8 col-xs-12 mail_listing">
                                    <div class="media m-b-30 p-t-20">
                                    	<h4 class="font-bold m-t-0">'.$row["name"].'
                                        <i style="float:right; font-size:15px; color:orange;">Disaster Type: '.$row["type"].'</i>
                                        </h4>
                                        <hr>
                                        <a class="pull-left" href="#"></a>
                                        <div class="media-body"> <span class="media-meta pull-right">'.$row["address"].'</span>
                                            <h4 class="text-danger m-0">'.$row["lat"].'</h4></div>
											<h4 class="text-danger m-0">'.$row["lng"].'</h4></div>
                                    ...
                                    <div class="b-all p-20">
									   ...
									   <a href="#" class="btn btn-danger btn-rounded btn-outline hidden-xs hidden-sm waves-effect waves-light" data-toggle="modal" data-target="#responsive-edit'.$row["id"].'">Edit This Post</a>
                                    </div>
                                </div>
                                ...
                                <!-- /.modal -->
                                            <div id="responsive-modal'.$row["id"].'" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <form action="functions/del_news.php" method="post">
                                            ...
                                            <!-- End Modal -->
								<!-- /.modal -->
                                            <div id="responsive-edit'.$row["id"].'" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                                                            
                                                        <form action="functions/upd_news.php" method="post">
                                                        <input type="hidden" name="id" value="'.$row["id"].'"/>
                                                ...
                                                <div class="col-xs-5">
                                                    <input type="text" class="form-control" id="name" name="name" value="'.$row["name"].'" required/></div>
                                            </div>
														<div class="form-group">
                                                <label class="col-xs-3 control-label">Post Title</label>
                                                <div class="col-xs-5">
                                                    <input type="text" class="form-control" id="address" name="address" value="'.$row["address"].'" required/></div>
                                            </div>
														<div class="form-group">
                                                <label class="col-xs-3 control-label">Post Title</label>
                                                <div class="col-xs-5">
                                                    <input type="text" class="form-control" id="type" name="type" value="'.$row["type"].'" required/></div>
													
                                            </div>
											<div class="form-group">
                                                <label class="col-xs-3 control-label">Post Title</label>
                                                <div class="col-xs-5">
                                                    <input type="text" class="form-control" id="lat" name="lat" value="'.$row["lat"].'" required/></div>
													
                                            </div>
											<div class="form-group">
                                                <label class="col-xs-3 control-label">Post Title</label>
                                                <div class="col-xs-5">
                                                    <input type="text" class="form-control" id="lng" name="lng" value="'.$row["lng"].'" required/></div>
													
                                            </div>
											</div>
											</div>
											<button type="button" class="btn btn-default waves-effect" data-dismiss="modal">Close</button>
                                                            <button type="submit" name="updatedata" class="btn btn-danger waves-effect waves-light">Edit</button>
                                                            </form>
                                                        </div>
                                                    </div>
                                                </div>
