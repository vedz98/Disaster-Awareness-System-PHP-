                                ...
                                ?>  
                                        ...
                                        <table class="table table-hover">
                                            <thead>
                                                <tr>
                                                    <th>
                                                        <h4>Recent Donation Request Forms(<b style="color: orange;"><?php echo mysqli_num_rows($query);?></b>)</h4>
                                                        <?php 
                                            ...
                                            <tbody>
                                              ...
                                              '
                                                <tr>
                                                   <td class="hidden-xs"><a href="inbox-detail.php?id='.$row["id"].'" />'.$row["ic_no"].'</td>
                                                    <td class="max-texts"><a href="inbox-detail.php?id='.$row["id"].'" />'.$row["phone_no"].'</td>
...
<button type="submit" id="print" name="print" class="btn btn-primary"><i class="fa fa-pdf" aria-hidden="true"></i>
Print</button>
</form>
                                    </div>
                                    <div class="row">
            ...
            <!-- /.container-fluid -->
            <footer class="footer text-center"> 2018 &copy; System Admin </footer>
        </div>
        <!-- /#page-wrapper -->
    </div>
    <!-- /#wrapper -->
