                    ...
                    <div class="col-sm-12">
                        <div class="white-box">
                            ...
                            <div id="exampleValidator" class="wizard">
								...
								?>
                                <form id="validation" class="form-horizontal" action="functions/update_post.php" method="post" enctype="multipart/form-data">
                                    <div class="wizard-content">
                                        <div class="wizard-pane active" role="tabpanel">
                                            <div class="form-group">
                                                ...
                                                <div class="col-xs-5">
                                                    <input type="text" class="form-control" id="author" name="author" value="<?php echo $author ?>"/></div>
                                            </div>
											<div class="form-group">
                                                <label class="col-xs-3 control-label">Post Title</label>
                                                <div class="col-xs-5">
                                                    <input type="text" class="form-control" id="title" name="title" value="<?php echo $title ?>" required/></div>
                                            </div>
											 <div class="form-group">
