                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        <div class="white-box">
                        		...
                        		<?php
									if (isset($_GET["success"])) {
										...
										'<div class="alert alert-success" >
					                         ...
					                         <strong>DONE!! </strong><p> The new System Administrator has been added. They can now log in to their account with their credentials.</p>
					                    </div>'
										;
									}
                            ...
                            <h3 class="box-title m-b-0">System Administrators ( <x style="color: orange;"><?php echo mysqli_num_rows($query);?></x> )</h3>
