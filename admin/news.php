                                    ...
                                    <div class="inbox-center">
                                        ...
                                        <table class="table table-hover">
                                            ...
                                            <thead>
                                                <tr>
                                                    <th>
                                                        <h4>Recent Disaster Updates (<b style="color: orange;"><?php echo mysqli_num_rows($query);?></b>)</h4>
                                                        <?php 
                                            ...
                                            <tbody>
                                             <?php
                                              ...
                                              echo
                                              '<tr>
                                                    <td class="hidden-xs"><a href="news-details.php?id='.$row["id"].'" />'.$row["name"].'</td>
                                                    <td class="max-texts"><a href="news-details.php?id='.$row["id"].'" />'.$row["address"].'</td>
                                                    </td>
