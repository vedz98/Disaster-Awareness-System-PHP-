...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
                        ...
                        <div class="white-box">
                            <div class="row">
                                ...
                                '<div class="col-lg-12 col-md-9 col-sm-8 col-xs-12 mail_listing">
                                    ...
                                    <img src="functions/upload/'.$row["image"].'" alt="Images">
                                    <hr>
                                            ...
                                            <div id="responsive-edit'.$row["id"].'" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <form action="functions/upd_posts.php" method="post">
                                                        <input type="hidden" name="id" value="'.$row["id"].'"/>
                                                ...
                                                <div class="col-xs-5">
                                                    <input type="text" class="form-control" id="author" name="author" value="'.$row["author"].'" required/></div>
                                            </div>
														<div class="form-group">
                                                <label class="col-xs-3 control-label">Post Title</label>
                                                <div class="col-xs-5">
                                                    <input type="text" class="form-control" id="title" name="title" value="'.$row["title"].'" required/></div>
                                            </div>
														<div class="form-group">
                                                <label class="col-xs-3 control-label">Post Title</label>
                                                <div class="col-xs-5">
                                                    <input type="text" class="form-control" id="content" name="content" value="'.$row["content"].'" required/></div>
            ...
            <!-- /.container-fluid -->
            <footer class="footer text-center"> 2021 &copy; Company Admin. </footer>
        </div>
        <!-- /#page-wrapper -->
    </div>
    <!-- /#wrapper -->
