...
<head>
    ...
    <title>System Admin (˵ ͡° ͜ʖ ͡°˵)| Settings</title>
    <!-- Bootstrap Core CSS -->
    ...
    <div id="wrapper">
        ...
        <div class="navbar-default sidebar" role="navigation">
            ...
            <button class="btn btn-default" type="button"> <i class="fa fa-search"></i> </button>
                   ...
                   <li><a href="inbox.php" class="waves-effect"><i data-icon=")" class="linea-icon linea-basic fa-fw"></i> <span class="hide-menu">Donation Request</span></a>
                    </li>
        ...
        <div id="page-wrapper">
            ...
            <!-- /.container-fluid -->
            <footer class="footer text-center"> 2018 &copy; System Admin (˵ ͡° ͜ʖ ͡°˵) </footer>
        </div>
        <!-- /#page-wrapper -->
    </div>
    <!-- /#wrapper -->
